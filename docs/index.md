---
title: Genetics
description: An interactive intelligent textbook for Genetics with a focus on analysis, genomics, and modern inference.
image: /img/cover.png
...
![Genetics Book Cover](./img/cover.png){ width="100%" }
